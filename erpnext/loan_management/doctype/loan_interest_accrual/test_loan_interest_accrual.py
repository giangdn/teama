...
class TestLoanInterestAccrual(unittest.TestCase):
    def setUp(self):
        ...
        self.applicant = frappe.db.get_value(
    ...
    def test_loan_interest_accural(self):
        ...
        loan_interest_accural = frappe.get_doc(
            "Loan Interest Accrual", {'loan': loan.name})

        self.assertEquals(flt(loan_interest_accural.interest_amount, 0), flt(
    ...
    def test_accumulated_amounts(self):
        ...
        self.assertEquals(flt(loan_interest_accrual.interest_amount, 0), flt(
            accrued_interest_amount, 0))
        ...
        self.assertEquals(flt(
            loan_interest_accrual.total_pending_interest_amount, 0), total_pending_interest_amount)
