...
class TestLoanDisbursement(unittest.TestCase):
    ...
    def test_loan_topup(self):
        ...
        loan = create_demand_loan(self.applicant, "Demand Loan",
                                  loan_application, posting_date=get_first_day(nowdate()))
        ...
        make_loan_disbursement_entry(
            loan.name, 500000, disbursement_date=add_days(last_date, 16))
