// Copyright (c) 2016, TeamA and contributors
...
frappe.ui.form.on("Program Enrollment", {
	...
	onload: function(frm) {
		...
		frm.fields_dict["fees"].grid.get_field(
			"fee_structure"
		...
		frm.set_query("student", function() {
			return {
				query:
					"erpnext.education.doctype.program_enrollment.program_enrollment.get_students",
				filters: {
					academic_year: frm.doc.academic_year,
...
frappe.ui.form.on("Program Enrollment Course", {
	courses_add: function(frm) {
		frm.fields_dict["courses"].grid.get_field(
			"course"
