...
def make_course_schedule_test_record(**args):
    ...
    course_schedule.to_time = args.to_time or course_schedule.from_time + \
        ...
        if args.simulate:
            while True:
                try:
                    ...
                    course_schedule.from_time = course_schedule.from_time + \
                        datetime.timedelta(minutes=10)
                    course_schedule.to_time = course_schedule.from_time + \
                        datetime.timedelta(hours=1)
        else:
            course_schedule.save()
