...
class AcademicTerm(Document):
    ...
    def validate(self):
        ...
        if self.term_start_date and self.term_end_date \
            ...
            frappe.throw(
                _("The Term End Date cannot be earlier than the Term Start Date. Please correct the dates and try again."))
...
def validate_duplication(self):
    ...
    if term:
        frappe.throw(_("An academic term with this 'Academic Year' {0} and 'Term Name' {1} already exists. Please modify these entries and try again.").format(
