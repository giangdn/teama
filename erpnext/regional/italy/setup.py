...
def make_custom_fields(update=True):
    ...
    custom_fields = {
        'Company': [
            ...
            dict(fieldname='cb_e_invoicing1', fieldtype='Column Break',
                 insert_after='vat_collectability', print_hide=1),
        ...
        'Customer': [
            dict(fieldname='fiscal_code', label='Fiscal Code',
                 fieldtype='Data', insert_after='tax_id', print_hide=1),
        ...
        'Payment Schedule': [
            dict(fieldname='mode_of_payment_code', label='Code',
                 ...
                 options="\n".join(map(lambda x: frappe.safe_decode(
                     x, encoding='utf-8'), mode_of_payment_codes)),
