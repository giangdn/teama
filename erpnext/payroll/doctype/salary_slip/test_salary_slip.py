...
class TestSalarySlip(unittest.TestCase):
    ...
    def test_payment_days_based_on_attendance(self):
        ...
        mark_attendance(emp_id, add_days(first_sunday, 1),
                        'Absent', ignore_validate=True)  # counted as absent
        mark_attendance(emp_id, add_days(first_sunday, 2), 'Half Day',
                        leave_type='Leave Without Pay', ignore_validate=True)  # valid 0.75 lwp
        mark_attendance(emp_id, add_days(first_sunday, 3), 'On Leave',
                        leave_type='Leave Without Pay', ignore_validate=True)  # valid lwp
        mark_attendance(emp_id, add_days(first_sunday, 4), 'On Leave',
                        leave_type='Casual Leave', ignore_validate=True)  # invalid lwp
        mark_attendance(emp_id, add_days(first_sunday, 7), 'On Leave',
                        leave_type='Leave Without Pay', ignore_validate=True)  # invalid lwp

        ss = make_employee_salary_slip(
            "test_payment_days_based_on_attendance@salary.com", "Monthly", "Test Payment Based On Attendence")
        ...
        self.assertEqual(ss.payment_days, days_in_month -
                         no_of_holidays - 2.25)
    ...
    def test_payment_days_based_on_leave_application(self):
        ...
        ss = make_employee_salary_slip(
            "test_payment_days_based_on_leave_application@salary.com", "Monthly", "Test Payment Based On Leave Application")
    ...
    def test_salary_slip_with_holidays_included(self):
        ...
        ss = make_employee_salary_slip(
            "test_salary_slip_with_holidays_included@salary.com", "Monthly", "Test Salary Slip With Holidays Included")
    ...
    def test_salary_slip_with_holidays_excluded(self):
        ...
        ss = make_employee_salary_slip(
            "test_salary_slip_with_holidays_excluded@salary.com", "Monthly",  "Test Salary Slip With Holidays Excluded")
    ...
    def test_payment_days(self):
        ...
        ss = make_employee_salary_slip(
            "test_payment_days@salary.com", "Monthly", "Test Payment Days")

        self.assertEqual(ss.total_working_days, no_of_days[0])
        self.assertEqual(
            ss.payment_days, (no_of_days[0] - getdate(date_of_joining).day + 1))
    ...
    def test_employee_salary_slip_read_permission(self):
        ...
        salary_slip_test_employee = make_employee_salary_slip(
            "test_employee_salary_slip_read_permission@salary.com", "Monthly", "Test Employee Salary Slip Read Permission")
    ...
    def test_email_salary_slip(self):
        ...
        ss = make_employee_salary_slip(
            "test_email_salary_slip@salary.com", "Monthly", "Test Salary Slip Email")
    ...
    def test_loan_repayment_salary_slip(self):
        ...
        loan = create_loan(applicant, "Car Loan", 11000, "Repay Over Number of Periods",
        ...
        self.assertEqual(ss.net_pay, (flt(ss.gross_pay) -
                                      (flt(ss.total_deduction) + flt(ss.total_loan_repayment))))

    def test_payroll_frequency(self):
        fiscal_year = get_fiscal_year(
            nowdate(), company=erpnext.get_default_company())[0]
        ...
        for payroll_frequency in ["Monthly", "Bimonthly", "Fortnightly", "Weekly", "Daily"]:
            ...
            ss = make_employee_salary_slip(payroll_frequency + "_test_employee@salary.com",
                                           payroll_frequency, payroll_frequency + "_Test Payroll Frequency")
    ...
    def test_multi_currency_salary_slip(self):
        ...
        salary_structure = make_salary_structure(
            "Test Multi Currency Salary Slip", "Monthly", employee=applicant, company="_Test Company", currency='USD')
        salary_slip = make_salary_slip(
            salary_structure.name, employee=applicant)
    ...
    def test_year_to_date_computation(self):
        ...
        applicant = make_employee(
            "test_ytd@salary.com", company="_Test Company")
        ...
        frappe.db.sql(
            "DELETE FROM `tabSalary Slip` where employee_name = 'test_ytd@salary.com'")
    ...
    def test_tax_for_payroll_period(self):
        ...
        try:
            ...
            raise
        frappe.db.sql(
            """delete from `tabSalary Slip` where employee=%s""", (employee))
        ...
        data["proof"] = create_proof_submission(
            employee, payroll_period, 120000)
        ...
        data["additional-1"] = create_additional_salary(
            employee, payroll_period, 150000)
        data["deducted_dates"] = create_salary_slips_for_payroll_period(employee,
                                                                        salary_structure.name, payroll_period)
        ...
        try:
            ...
            raise
        frappe.db.sql(
            """delete from `tabAdditional Salary` where employee=%s""", (employee))
...
def make_salary_component(salary_components, test_tax, company_list=None):
    for salary_component in salary_components:
        ...
        get_salary_component_account(
            salary_component["salary_component"], company_list)
...
def create_account(account_name, company, parent_account):
    ...
    account = frappe.db.get_value(
        "Account", account_name + " - " + company_abbr)
    if not account:
        frappe.get_doc({
            "doctype": "Account",
...
def create_proof_submission(employee, payroll_period, amount):
    submission_date = add_months(
        payroll_period.start_date, random.randint(0, 11))
...
def make_holiday_list():
    fiscal_year = get_fiscal_year(
        nowdate(), company=erpnext.get_default_company())
