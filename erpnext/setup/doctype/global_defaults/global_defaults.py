...
class GlobalDefaults(Document):
    ...
    def on_update(self):
        ...
        if year_start_end_date:
            ...
            if ysd and yed:
                ...
                frappe.db.set_default(
                    'year_end_date', yed.strftime('%Y-%m-%d'))
    ...
    def toggle_rounded_total(self):
        ...
        for doctype in ("Quotation", "Sales Order", "Sales Invoice", "Delivery Note",
            ...
            make_property_setter(doctype, "base_rounded_total",
                                 "hidden", self.disable_rounded_total, "Check")
            make_property_setter(
                doctype, "base_rounded_total", "print_hide", 1, "Check")

            make_property_setter(doctype, "rounded_total",
                                 "hidden", self.disable_rounded_total, "Check")
            make_property_setter(
                doctype, "rounded_total", "print_hide", self.disable_rounded_total, "Check")
    ...
    def toggle_in_words(self):
        ...
        for doctype in ("Quotation", "Sales Order", "Sales Invoice", "Delivery Note",
            ...
            make_property_setter(doctype, "in_words",
                                 "hidden", self.disable_in_words, "Check")
            make_property_setter(doctype, "in_words",
                                 "print_hide", self.disable_in_words, "Check")
