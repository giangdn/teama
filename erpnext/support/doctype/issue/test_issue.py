...
class TestIssue(unittest.TestCase):
    ...
    def test_response_time_and_resolution_time_based_on_different_sla(self):
        ...
        self.assertEquals(issue.response_by,
                          datetime.datetime(2019, 3, 4, 14, 0))
        self.assertEquals(issue.resolution_by,
                          datetime.datetime(2019, 3, 4, 15, 0))
        ...
        self.assertEquals(issue.response_by,
                          datetime.datetime(2019, 3, 4, 16, 0))
        self.assertEquals(issue.resolution_by,
                          datetime.datetime(2019, 3, 4, 18, 0))
        ...
        self.assertEquals(issue.response_by,
                          datetime.datetime(2019, 3, 6, 14, 0))
        self.assertEquals(issue.resolution_by,
                          datetime.datetime(2019, 3, 6, 16, 0))
        ...
        self.assertEquals(issue.response_by,
                          datetime.datetime(2019, 3, 4, 18, 0))
        self.assertEquals(issue.resolution_by,
                          datetime.datetime(2019, 3, 6, 12, 0))
    ...
    def test_issue_metrics(self):
        ...
        create_communication(
            issue.name, "test@example.com", "Received", creation)
    ...
    def test_hold_time_on_replied(self):
        ...
        self.assertEqual(issue.resolution_by,
                         datetime.datetime(2020, 3, 4, 16, 45))
