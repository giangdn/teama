...
class TestSupplier(unittest.TestCase):
    def test_supplier_default_payment_terms(self):
        ...
        due_date = get_due_date("2016-01-22", "Supplier",
                                "_Test Supplier With Template 1")
        self.assertEqual(due_date, "2016-02-21")

        due_date = get_due_date("2017-01-22", "Supplier",
                                "_Test Supplier With Template 1")
        ...
        frappe.db.set_value(
            "Supplier", "_Test Supplier With Template 1", "payment_terms", "")

        # Set credit limit for the supplier group instead of supplier and evaluate the due date
        frappe.db.set_value("Supplier Group", "_Test Supplier Group",
        ...
        frappe.db.set_value(
            "Supplier Group", "_Test Supplier Group", "payment_terms", "")
    ...
    def test_party_details_tax_category(self):
        ...
        details = get_party_details(
            "_Test Supplier With Tax Category", party_type="Supplier")
