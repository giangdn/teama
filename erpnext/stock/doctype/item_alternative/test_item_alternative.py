...
class TestItemAlternative(unittest.TestCase):
    ...
    def test_alternative_item_for_subcontract_rm(self):
        ...
        self.assertEqual(after_transfer_reserved_qty_for_sub_contract, flt(
    ...
    def test_alternative_item_for_production_rm(self):
        ...
        ste = frappe.get_doc(make_stock_entry(
            pro_order.name, "Material Transfer for Manufacture", 5))
        ste.insert()
        ...
        self.assertEqual(reserved_qty_for_production_after_transfer, flt(
            reserved_qty_for_production - 5))
        ste1 = frappe.get_doc(make_stock_entry(
            pro_order.name, "Manufacture", 5))
...
def make_items():
    items = ['Test Finished Goods - A', 'Test FG A RW 1',
             'Test FG A RW 2', 'Alternate Item For A RW 1']
