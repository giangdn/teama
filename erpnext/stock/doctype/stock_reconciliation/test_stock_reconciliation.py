...
class TestStockReconciliation(unittest.TestCase):
    ...
    def _test_reco_sle_gle(self, valuation_method):
        ...
        for d in input_data:
            ...
            if qty_after_transaction == last_sle.get("qty_after_transaction") \
                ...
                self.assertEqual(flt(sle[0].qty_after_transaction, 1), flt(
                    qty_after_transaction, 1))
                self.assertEqual(flt(sle[0].stock_value, 1), flt(
                    qty_after_transaction * valuation_rate, 1))
    ...
    def test_get_items(self):
        ...
        items = get_items("_Test Warehouse Group 1 - _TC",
                          nowdate(), nowtime(), "_Test Company")
...
def create_stock_reconciliation(**args):
    ...
    sr.expense_account = args.expense_account or \
        ("Stock Adjustment - _TC" if frappe.get_all("Stock Ledger Entry")
