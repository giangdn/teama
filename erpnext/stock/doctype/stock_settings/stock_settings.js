...
frappe.tour["Stock Settings"] = [
	{
		...
		description:
			__(
				"By default, the Item Name is set as per the Item Code entered. If you want Items to be named by a "
			) +
	...
	},
	{
		...
		description: __(
			"This will allow stock items to be displayed in negative values. Using this option depends on your use case. With this option unchecked, the system warns before obstructing a transaction that is causing negative stock."
		)
	},
	{
	...
	},
	{
		...
		description: __(
			"Serial numbers for stock will be set automatically based on the Items entered based on first in first out in transactions like Purchase/Sales Invoices, Delivery Notes, etc."
		)
	}
];
