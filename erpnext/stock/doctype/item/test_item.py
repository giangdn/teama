...
class TestItem(unittest.TestCase):
    ...
    def test_item_tax_template(self):
        ...
        for data in expected_item_tax_template:
            ...
            self.assertEqual(details.item_tax_template,
                             data['item_tax_template'])
            self.assertEqual(json.loads(details.item_tax_rate),
                             expected_item_tax_map[details.item_tax_template])
    ...
    def test_item_defaults(self):
        ...
        make_item("Test Item With Defaults", {
            ...
            "item_defaults": [{
                ...
                "buying_cost_center": "_Test Write Off Cost Center - _TC",
            }]
        })
    ...
    def test_item_merging(self):
        ...
        frappe.rename_doc("Item", "Test Item for Merging 1",
                          "Test Item for Merging 2", merge=True)
    ...
    def test_stock_exists_against_template_item(self):
        stock_item = frappe.get_all(
            'Stock Ledger Entry', fields=["item_code"], limit=1)
        if stock_item:
