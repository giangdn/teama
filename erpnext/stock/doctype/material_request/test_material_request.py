...
class TestMaterialRequest(unittest.TestCase):
    ...
    def test_make_supplier_quotation(self):
        ...
        self.assertRaises(frappe.ValidationError,
                          make_supplier_quotation, mr.name)
    ...
    def test_cannot_change_cancelled_mr(self):
        ...
        self.assertRaises(frappe.InvalidStatusError,
                          mr.update_status, 'Stopped')
        self.assertRaises(frappe.InvalidStatusError,
                          mr.update_status, 'Ordered')
        self.assertRaises(frappe.InvalidStatusError,
                          mr.update_status, 'Issued')
        self.assertRaises(frappe.InvalidStatusError,
                          mr.update_status, 'Transferred')
        self.assertRaises(frappe.InvalidStatusError,
                          mr.update_status, 'Pending')
    ...
    def test_completed_qty_for_purchase(self):
        ...
        self.assertEqual(current_requested_qty_item1,
                         existing_requested_qty_item1 + 27.0)
        self.assertEqual(current_requested_qty_item2,
    ...
    def test_incorrect_mapping_of_stock_entry(self):
        ...
        se_doc = make_stock_entry(mr.name)
        self.assertEqual(se_doc.get("items")[
                         0].s_warehouse, "_Test Warehouse - _TC")
