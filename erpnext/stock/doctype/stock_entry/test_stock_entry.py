...
class TestStockEntry(unittest.TestCase):
    ...
    def test_fifo(self):
        ...
        make_stock_entry(item_code=item_code,
                         target=warehouse, qty=1, basic_rate=10)
        ...
        # negative qty
        make_stock_entry(item_code=item_code,
                         source=warehouse, qty=2, basic_rate=10)
        sle = get_sle(item_code=item_code, warehouse=warehouse)[0]
    ...
    def test_auto_material_request(self):
        ...
        self._test_auto_material_request(
            "_Test Item", material_request_type="Transfer")
    ...
    def test_material_receipt_gl_entry(self):
        ...
        stock_in_hand_account = get_inventory_account(
            mr.company, mr.get("items")[0].t_warehouse)
    ...
    def test_material_transfer_gl_entry(self):
        ...
        source_warehouse_account = get_inventory_account(
            mtn.company, mtn.get("items")[0].s_warehouse)

        target_warehouse_account = get_inventory_account(
            mtn.company, mtn.get("items")[0].t_warehouse)
        ...
        if source_warehouse_account == target_warehouse_account:
            ...
            self.check_gl_entries("Stock Entry", mtn.name,
                                  sorted([
                                      [source_warehouse_account,
                                          0.0, stock_value_diff],
                                      [target_warehouse_account,
                                          stock_value_diff, 0.0],
                                  ])
                                  )
    ...
    def test_repack_no_change_in_valuation(self):
        company = frappe.db.get_value(
            'Warehouse', '_Test Warehouse - _TC', 'company')

        make_stock_entry(item_code="_Test Item",
                         target="_Test Warehouse - _TC", qty=50, basic_rate=100)
    ...
    def test_repack_with_additional_costs(self):
        ...
        repack = make_stock_entry(
            company=company, purpose="Repack", do_not_save=True)
        repack.posting_date = nowdate()
        repack.posting_time = nowtime()
        ...
        stock_in_hand_account = get_inventory_account(
            repack.company, repack.get("items")[1].t_warehouse)
    ...
    def test_serial_no_not_exists(self):
        frappe.db.sql(
            "delete from `tabSerial No` where name in ('ABCD', 'EFGH')")
    ...
    def test_serial_item_error(self):
        ...
        if not frappe.db.exists('Serial No', 'ABCD'):
            make_serialized_item(
                item_code="_Test Serialized Item", serial_no="ABCD\nEFGH")
    ...
    def test_serial_move(self):
        ...
        self.assertTrue(frappe.db.get_value(
            "Serial No", serial_no, "warehouse"), "_Test Warehouse 1 - _TC")

        se.cancel()
        self.assertTrue(frappe.db.get_value(
            "Serial No", serial_no, "warehouse"), "_Test Warehouse - _TC")
    ...
    def test_warehouse_company_validation(self):
        company = frappe.db.get_value(
            'Warehouse', '_Test Warehouse 2 - _TC1', 'company')
    ...
    def test_freeze_stocks(self):
        ...
        frappe.db.set_value("Stock Settings", None,
                            "stock_frozen_upto", add_days(nowdate(), 5))
    ...
    def test_work_order(self):
        ...
        make_stock_entry(item_code="_Test Item 2",
                         target="_Test Warehouse - _TC", qty=50, basic_rate=20)
        ...
        fg_cost = list(filter(lambda x: x.item_code ==
                              "_Test FG Item 2", stock_entry.get("items")))[0].amount
    ...
    def test_retain_sample(self):
        ...
        frappe.db.set_value("Stock Settings", None, "sample_retention_warehouse",
        ...
        qty_in_usable_warehouse = get_batch_qty(receipt_entry.get(
            "items")[0].batch_no, "_Test Warehouse - _TC", "_Test Item")
        qty_in_retention_warehouse = get_batch_qty(receipt_entry.get(
            "items")[0].batch_no, "Test Warehouse for Sample Retention - _TC", "_Test Item")
    ...
    def test_customer_provided_parts_se(self):
        create_item('CUST-0987', is_customer_provided_item=1,
...
def make_serialized_item(**args):
    ...
    se.get("items")[
        0].item_code = args.item_code or "_Test Serialized Item With Series"
