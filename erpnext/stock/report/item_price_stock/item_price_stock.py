...
def get_item_price_qty_data(filters):
    ...
    price_list_names = list(
        set([item.price_list_name for item in item_results]))
    ...
    if item_results:
        for item_dict in item_results:
            ...
            if buying_price_map.get(price_list):
                data["buying_price_list"] = buying_price_map.get(
                    price_list)["Buying Price List"] or ""
                data["buying_rate"] = buying_price_map.get(price_list)[
                    "Buying Rate"] or 0
            if selling_price_map.get(price_list):
                data["selling_price_list"] = selling_price_map.get(
                    price_list)["Selling Price List"] or ""
                data["selling_rate"] = selling_price_map.get(price_list)[
                    "Selling Rate"] or 0
