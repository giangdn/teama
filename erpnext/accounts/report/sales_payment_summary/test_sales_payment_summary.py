...
class TestSalesPaymentSummary(unittest.TestCase):
    ...
    def test_get_mode_of_payments(self):
        ...
        for dummy in range(2):
            ...
            pe = get_payment_entry(
                "Sales Invoice", si.name, bank_account=bank_account)
        ...
        payment_entries = frappe.get_all("Payment Entry", filters={
                                         "mode_of_payment": "Cash", "docstatus": 1}, fields=["name", "docstatus"])
    ...
    def test_get_mode_of_payments_details(self):
        ...
        payment_entries = frappe.get_all("Payment Entry", filters={
                                         "mode_of_payment": "Credit Card", "docstatus": 1}, fields=["name", "docstatus"])
