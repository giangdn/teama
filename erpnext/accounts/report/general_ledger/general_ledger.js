	...
	filters: [
		...
		},
		{
			...
			get_data: function(txt) {
				...
				let party_type = frappe.query_report.get_filter_value(
					"party_type"
				);
			...
			on_change: function() {
				var party_type = frappe.query_report.get_filter_value(
					"party_type"
				);
				...
				if (!party_type || parties.length === 0 || parties.length > 1) {
					...
					frappe.db.get_value(party_type, party, fieldname, function(
						value
					) {
						frappe.query_report.set_filter_value(
							"party_name",
