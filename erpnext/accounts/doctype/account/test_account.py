...
class TestAccount(unittest.TestCase):
    def test_rename_account(self):
        ...
        update_account_number("1210 - Debtors - _TC",
                              new_account_name, new_account_number)
        ...
        frappe.delete_doc(
            "Account", "1211-11-4 - 6 - Debtors 1 - Test - - _TC")
    ...
    def test_merge_account(self):
        ...
        parent = frappe.db.get_value(
            "Account", "Earnest Money - _TC", "parent_account")

        self.assertEqual(parent, "Securities and Deposits - _TC")

        merge_account("Securities and Deposits - _TC",
                      "Cash In Hand - _TC", doc.is_group, doc.root_type, doc.company)
        parent = frappe.db.get_value(
            "Account", "Earnest Money - _TC", "parent_account")
        ...
        self.assertFalse(frappe.db.exists(
            "Account", "Securities and Deposits - _TC"))
    ...
    def test_account_rename_sync(self):
        ...
        self.assertTrue(frappe.db.exists("Account", {
                        'account_name': "Test Rename Sync Account", "company": "_Test Company 4", "account_number": "1234"}))
        self.assertTrue(frappe.db.exists("Account", {
                        'account_name': "Test Rename Sync Account", "company": "_Test Company 5", "account_number": "1234"}))
    ...
    def test_child_company_account_rename_sync(self):
        ...
        frappe.db.set_value("Company", "_Test Company 5",
                            "allow_account_creation_against_child_company", 1)

        update_account_number(acc_tc_5, "Test Modified Account")
        self.assertTrue(frappe.db.exists("Account", {
                        'name': "Test Modified Account - _TC5", "company": "_Test Company 5"}))

        frappe.db.set_value("Company", "_Test Company 5",
                            "allow_account_creation_against_child_company", 0)

        to_delete = ["Test Group Account - _TC3",
                     "Test Group Account - _TC4", "Test Modified Account - _TC5"]
...
def _make_test_records(verbose=None):
    ...
    accounts = [
        ...
        ["_Test Account Shipping Charges",
         "_Test Account Stock Expenses", 0, "Chargeable", None],
        ["_Test Account Customs Duty",
         "_Test Account Stock Expenses", 0, "Tax", None],
        ["_Test Account Insurance Charges",
         "_Test Account Stock Expenses", 0, "Chargeable", None],
        ["_Test Account Stock Adjustment",
         "_Test Account Stock Expenses", 0, "Stock Adjustment", None],
        ...
        ["_Test Account Reserves and Surplus",
         "Current Liabilities", 0, None, None],

        ["_Test Account Cost for Goods Sold", "Expenses", 0, None, None],
        ["_Test Account Excise Duty", "_Test Account Tax Assets", 0, "Tax", None],
        ["_Test Account Education Cess",
         "_Test Account Tax Assets", 0, "Tax", None],
        ["_Test Account S&H Education Cess",
         "_Test Account Tax Assets", 0, "Tax", None],
        ...
        ["_Test Accumulated Depreciations", "Current Assets",
...
def create_account(**kwargs):
    account = frappe.db.get_value("Account", filters={"account_name": kwargs.get(
        "account_name"), "company": kwargs.get("company")})
    if account:
        return account
    else:
