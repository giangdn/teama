...
class TestPurchaseInvoice(unittest.TestCase):
    ...
    def test_gl_entries_without_perpetual_inventory(self):
        ...
        self.assertTrue(
            not cint(erpnext.is_perpetual_inventory_enabled(pi.company)))
        pi.insert()
        pi.submit()
    ...
    def test_payment_entry_unlink_against_purchase_invoice(self):
        ...
        pe = get_payment_entry(
            "Purchase Invoice", pi_doc.name, bank_account="_Test Bank - _TC")
        pe.reference_no = "1"
    ...
    def test_purchase_invoice_for_blocked_supplier_payment_past_date(self):
        ...
        with self.assertRaises(Exception):
            try:
                ...
                get_payment_entry('Purchase Invoice', dn=pi.name,
                                  bank_account="_Test Bank - _TC")
    ...
    def test_purchase_invoice_temporary_blocked(self):
        ...
        pe = get_payment_entry(
            'Purchase Invoice', dn=pi.name, bank_account="_Test Bank - _TC")
    ...
    def test_gl_entries_with_perpetual_inventory_against_pr(self):
        ...
        pi = make_purchase_invoice(company="_Test Company with perpetual inventory", supplier_warehouse="Work In Progress - TCP1", warehouse="Stores - TCP1",
                                   cost_center="Main - TCP1", expense_account="_Test Account Cost for Goods Sold - TCP1", get_taxes_and_charges=True, qty=10, do_not_save="True")
    ...
    def test_invoice_with_advance_and_multi_payment_terms(self):
        ...
        self.assertEqual(
            pi.payment_schedule[1].due_date, add_days(pi.posting_date, 30))
    ...
    def test_total_purchase_cost_for_project(self):
        if not frappe.db.exists("Project", {"project_name": "_Test Project for Purchase"}):
            project = make_project(
                {'project_name': '_Test Project for Purchase'})
        else:
            project = frappe.get_doc(
                "Project", {"project_name": "_Test Project for Purchase"})
        ...
        pi = make_purchase_invoice(
            currency="USD", conversion_rate=60, project=project.name)
        ...
        self.assertEqual(frappe.db.get_value(
            "Project", project.name, "total_purchase_cost"), existing_purchase_cost)
    ...
    def test_update_stock_and_purchase_return(self):
        ...
        pi1 = make_purchase_invoice(
            is_return=1, return_against=pi.name, qty=-2, rate=50, update_stock=1)
    ...
    def test_outstanding_amount_after_advance_jv_cancelation(self):
        ...
        self.assertEqual(flt(pi.outstanding_amount), flt(
            pi.rounded_total - pi.total_advance))
    ...
    def test_duplicate_due_date_in_terms(self):
        pi = make_purchase_invoice(do_not_save=1)
        pi.append('payment_schedule', dict(due_date='2017-01-01',
    ...
    def test_deferred_expense_via_journal_entry(self):
        ...
        pi = make_purchase_invoice(
            item=item.name, qty=1, rate=100, do_not_save=True)
