...
class TestTaxWithholdingCategory(unittest.TestCase):
    ...
    def test_cumulative_threshold_tds(self):
        frappe.db.set_value("Supplier", "Test TDS Supplier",
    ...
    def test_single_threshold_tds(self):
        invoices = []
        frappe.db.set_value("Supplier", "Test TDS Supplier1",
        ...
        gl_entries = frappe.db.get_all(
            'GL Entry', filters={'voucher_no': pi.name}, fields=["*"])
    ...
    def test_single_threshold_tds_with_previous_vouchers(self):
        invoices = []
        frappe.db.set_value("Supplier", "Test TDS Supplier2",
                            "tax_withholding_category", "Single Threshold TDS")
