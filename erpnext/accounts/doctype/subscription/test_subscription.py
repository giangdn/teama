...
class TestSubscription(unittest.TestCase):
    ...
    def test_create_subscription_with_trial_with_correct_period(self):
        ...
        self.assertEqual(subscription.trial_period_end,
                         add_months(nowdate(), 1))
        self.assertEqual(add_days(subscription.trial_period_end, 1),
                         get_date_str(subscription.current_invoice_start))
        self.assertEqual(add_to_date(subscription.current_invoice_start,
                                     months=1, days=-1), get_date_str(subscription.current_invoice_end))
    ...
    def test_status_goes_back_to_active_after_invoice_is_paid(self):
        ...
        self.assertEqual(subscription.current_invoice_start,
                         add_months(subscription.start_date, 1))
        self.assertEqual(len(subscription.invoices), 1)
    ...
    def test_subscription_cancellation_invoices(self):
        ...
        plan_days = flt(date_diff(subscription.current_invoice_end,
        ...
        self.assertEqual(
            flt(
                get_prorata_factor(
                    subscription.current_invoice_end, subscription.current_invoice_start),
                2),
    ...
    def test_subscription_with_follow_calendar_months(self):
        ...
        self.assertEqual(get_date_str(
            subscription.current_invoice_end), '2018-03-31')
