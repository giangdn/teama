...
class TestPOSInvoice(unittest.TestCase):
    ...
    def test_pos_returns_with_repayment(self):
        ...
        pos.append("payments", {'mode_of_payment': 'Cash',
                                'account': 'Cash - _TC', 'amount': 500, 'default': 1})
        pos.insert()
        pos.submit()
    ...
    def test_pos_change_amount(self):
        ...
        pos.set('payments', [])
        pos.append("payments", {'mode_of_payment': 'Bank Draft',
                                'account': '_Test Bank - _TC', 'amount': 50})
        pos.append("payments", {'mode_of_payment': 'Cash',
                                'account': 'Cash - _TC', 'amount': 60, 'default': 1})
    ...
    def test_serialized_item_transaction(self):
        ...
        pos.append("payments", {'mode_of_payment': 'Bank Draft',
                                'account': '_Test Bank - _TC', 'amount': 1000})
        ...
        pos2.append("payments", {'mode_of_payment': 'Bank Draft',
                                 'account': '_Test Bank - _TC', 'amount': 1000})
    ...
    def test_loyalty_points(self):
        ...
        create_records()
        frappe.db.set_value("Customer", "Test Loyalty Customer",
        ...
        lpe = frappe.get_doc('Loyalty Point Entry', {
        ...
        self.assertEqual(after_lp_details.loyalty_points,
                         before_lp_details.loyalty_points + 10)

        inv.cancel()
        after_cancel_lp_details = get_loyalty_program_details_with_points(
            inv.customer, company=inv.company, loyalty_program=inv.loyalty_program)
        self.assertEqual(after_cancel_lp_details.loyalty_points,
                         before_lp_details.loyalty_points)
    ...
    def test_loyalty_points_redeemption(self):
        ...
        inv = create_pos_invoice(
            customer="Test Loyalty Customer", rate=10000, do_not_save=1)
        ...
        inv.append("payments", {'mode_of_payment': 'Cash',
                                'account': 'Cash - _TC', 'amount': 10000 - inv.loyalty_amount})
    ...
    def test_merging_into_sales_invoice_with_discount(self):
        ...
        pos_inv = create_pos_invoice(
            rate=300, additional_discount_percentage=10, do_not_submit=1)
    ...
    def test_merging_with_validate_selling_price(self):
        ...
        if not frappe.db.get_single_value("Selling Settings", "validate_selling_price"):
            frappe.db.set_value(
                "Selling Settings", "Selling Settings", "validate_selling_price", 1)

        make_purchase_receipt(item_code="_Test Item",
                              warehouse="_Test Warehouse - _TC", qty=1, rate=300)
        frappe.db.sql("delete from `tabPOS Invoice`")
        test_user, pos_profile = init_user_and_profile()
        pos_inv = create_pos_invoice(rate=300, do_not_submit=1)
        pos_inv.append('payments', {
        ...
        frappe.set_user("Administrator")
        frappe.db.set_value("Selling Settings",
