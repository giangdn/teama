...
class TestCustomer(unittest.TestCase):
    ...
    def test_party_details_tax_category(self):
        ...
        frappe.delete_doc_if_exists(
            "Address", "_Test Address With Tax Category-Billing")
        frappe.delete_doc_if_exists(
            "Address", "_Test Address With Tax Category-Shipping")
    ...
    def test_duplicate_customer(self):
        frappe.db.sql(
            "delete from `tabCustomer` where customer_name='_Test Customer 1'")
        ...
        self.assertEqual(test_customer_1.customer_name,
                         duplicate_customer.customer_name)

    def get_customer_outstanding_amount(self):
        from erpnext.selling.doctype.sales_order.test_sales_order import make_sales_order
        outstanding_amt = get_customer_outstanding(
            '_Test Customer', '_Test Company')
    ...
    def test_customer_credit_limit_on_change(self):
        ...
        customer.append('credit_limits', {'credit_limit': flt(
            outstanding_amt - 100), 'company': '_Test Company'})
    ...
    def test_customer_payment_terms(self):
        ...
        frappe.db.set_value(
            "Customer", "_Test Customer With Template", "payment_terms", "")
