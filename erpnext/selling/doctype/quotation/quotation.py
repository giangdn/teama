        ...
        if not self.has_sales_order():
            ...
            for reason in lost_reasons_list:
                if reason.get('lost_reason') in lost_reasons_lst:
                    ...
                    frappe.throw(_("Invalid lost reason {0}, please create a new lost reason").format(
...
def make_sales_order(source_name, target_doc=None):
    quotation = frappe.db.get_value("Quotation", source_name, [
                                    "transaction_date", "valid_till"], as_dict=1)
            ...
            if not customer_name:
                ...
                try:
                    ...
                    lead_link = frappe.utils.get_link_to_form(
                        "Lead", lead_name)
                    message = _(
                        "Could not auto create Customer due to the following missing mandatory field(s):") + "<br>"
                    message += "<br><ul><li>" + \
