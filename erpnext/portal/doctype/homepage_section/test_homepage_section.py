...
class TestHomepageSection(unittest.TestCase):
    def test_homepage_section_card(self):
            ...
            frappe.get_doc({
                ...
                'section_cards': [
                        {'title': 'Card 1', 'subtitle': 'Subtitle 1',
                         'content': 'This is test card 1', 'route': '/card-1'},
                        {'title': 'Card 2', 'subtitle': 'Subtitle 2',
                         'content': 'This is test card 2', 'image': 'test.jpg'},
                ],
                'no_of_columns': 3
            }).insert()
        ...
        self.assertEqual(cards[1].find(
            class_='website-image-lazy')['data-src'], 'test.jpg')
