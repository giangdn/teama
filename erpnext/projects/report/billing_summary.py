...
def get_data(filters):
    ...
    for ts, ts_details in timesheet_details.items():
        ...
        for row in ts_details:
            ...
            activity_duration, billing_duration = get_billable_and_total_duration(
...
def get_timesheets(filters):
    ...
    timesheets = frappe.get_all("Timesheet", filters=record_filters, fields=[
...
def get_timesheet_details(filters, timesheet_list):
    ...
    timesheet_details = frappe.get_all(
        ...
        fields=["from_time", "to_time", "hours", "billable",
                "billing_hours", "billing_rate", "parent"]
    )
