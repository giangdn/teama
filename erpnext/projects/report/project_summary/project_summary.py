...
def execute(filters=None):
    ...
    data = frappe.db.get_all("Project", filters=filters, fields=[
                             "name", 'status', "percent_complete", "expected_start_date", "expected_end_date", "project_type"], order_by="expected_end_date")
...
def get_report_summary(data):
    ...
    avg_completion = sum(
        [project.percent_complete for project in data]) / len(data)
