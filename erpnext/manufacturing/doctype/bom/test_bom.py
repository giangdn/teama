...
class TestBOM(unittest.TestCase):
    ...
    def test_get_items_exploded(self):
        ...
        self.assertTrue(test_records[2]["items"][0]["item_code"] in items_dict)
        self.assertFalse(test_records[2]["items"]
                         [1]["item_code"] in items_dict)
    ...
    def test_get_items_list(self):
        ...
        self.assertEqual(
            len(get_bom_items(bom=get_default_bom(), company="_Test Company")), 3)
    ...
    def test_default_bom(self):
        ...
        bom = frappe.get_doc(
            "BOM", {"item": "_Test FG Item 2", "is_default": 1})
    ...
    def test_update_bom_cost_in_all_boms(self):
        ...
        reset_item_valuation_rate(
            item_code='_Test Item 2', qty=200, rate=rm_rate + 10)
    ...
    def test_bom_cost_multi_uom_multi_currency_based_on_price_list(self):
        frappe.db.set_value("Price List", "_Test Price List",
