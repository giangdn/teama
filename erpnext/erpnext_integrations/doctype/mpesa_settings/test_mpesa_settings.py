...
class TestMpesaSettings(unittest.TestCase):
    ...
    def test_creation_of_payment_gateway(self):
        ...
        self.assertTrue(frappe.db.exists("Payment Gateway Account", {
    ...
    def test_processing_of_account_balance(self):
        mpesa_doc = create_mpesa_settings(
            payment_gateway_name="_Account Balance")
    ...
    def test_processing_of_callback_payload(self):
        ...
        mpesa_account = frappe.db.get_value("Payment Gateway Account", {
                                            "payment_gateway": 'Mpesa-Payment'}, "payment_account")
        frappe.db.set_value("Account", mpesa_account,
                            "account_currency", "KES")
        frappe.db.set_value("Customer", "_Test Customer",
                            "default_currency", "KES")

        pos_invoice = create_pos_invoice(do_not_submit=1)
        pos_invoice.append("payments", {
                           'mode_of_payment': 'Mpesa-Payment', 'account': mpesa_account, 'amount': 500})
    ...
    def test_processing_of_multiple_callback_payload(self):
        ...
        frappe.db.set_value("Account", mpesa_account,
                            "account_currency", "KES")
        frappe.db.set_value("Mpesa Settings", "Payment",
        ...
        pos_invoice = create_pos_invoice(do_not_submit=1)
        pos_invoice.append("payments", {
                           'mode_of_payment': 'Mpesa-Payment', 'account': mpesa_account, 'amount': 1000})
        pos_invoice.contact_mobile = "093456543894"
        pos_invoice.currency = "KES"
        pos_invoice.save()
        ...
        mpesa_receipt_numbers = [frappe.utils.random_string(
            5) for d in integration_req_ids]
        ...
        pos_invoice.reload()
        self.assertEquals(pos_invoice.mpesa_receipt_number,
