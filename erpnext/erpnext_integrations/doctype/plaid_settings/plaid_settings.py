...
def get_transactions(bank, bank_account=None, start_date=None, end_date=None):
    ...
    if bank_account:
        related_bank = frappe.db.get_values("Bank Account", bank_account, [
                                            "bank", "integration_id"], as_dict=True)
...
def new_bank_transaction(transaction):
    ...
    bank_account = frappe.db.get_value("Bank Account", dict(
        integration_id=transaction["account_id"]))
