...
def get_level():
    ...
    communication_number = frappe.db.count(
        'Communication', dict(communication_medium='Email'))
...
def get_help_messages():
    ...
    domain = frappe.get_cached_value(
        'Company',  erpnext.get_default_company(),  'domain')
    messages = []
    ...
    message_settings = [
        ...
        frappe._dict(
            ...
            description=_(
                'Students are at the heart of the system, add all your students'),
        ...
        frappe._dict(
            ...
            description=_(
                'Student Batches help you track attendance, assessments and fees for students'),
        ...
        frappe._dict(
            ...
            description=_(
                'Create Employee records to manage leaves, expense claims and payroll'),
