...
def get_data(filters):
    ...
    staffing_plan_list = list(set([details["name"]
                                   for details in staffing_plan_details]))
...
def get_job_opening(sp_list):
    ...
    job_openings = frappe.get_all("Job Opening", filters=[
                                  ["staffing_plan", "IN", sp_list]], fields=["name", "staffing_plan"])
...
def get_job_applicant(jo_list):
    ...
    applicants = frappe.get_all("Job Applicant", filters=[["job_title", "IN", jo_list]], fields=[
                                "name", "job_title", "applicant_name", 'status'])
...
def get_job_offer(ja_list):
    ...
    offers = frappe.get_all("Job Offer", filters=[["job_applicant", "IN", ja_list]], fields=[
                            "name", "job_applicant", "status", 'offer_date', 'designation'])
