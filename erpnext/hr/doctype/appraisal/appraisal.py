...
class Appraisal(Document):
    ...
    def validate_existing_appraisal(self):
        ...
        if chk:
            frappe.throw(_("Appraisal {0} created for Employee {1} in the given date range").format(
    ...
    def calculate_total(self):
        ...
        if int(total_w) != 100:
            frappe.throw(_("Total weightage assigned should be 100%.<br>It is {0}").format(
                str(total_w) + "%"))
